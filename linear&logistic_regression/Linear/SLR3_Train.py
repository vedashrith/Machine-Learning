...
plt.xlabel('Step')
plt.ylabel('Loss')
plt.title('Loss vs Step for predicting petal length using petal width')
plt.grid(True)
...
model.save('model3_parameters.npz')
print("Model parameters saved as model3_parameters.npz in the current directory!!!")
...
plt.xlabel('Step')
plt.ylabel('Loss')
plt.title('Loss vs Step for Regularized model 3')
plt.grid(True)
plt.savefig('Reg_model3_loss.png')
plt.show()
...
model_reg.save('Reg_model3_parameters.npz')
print("Model parameters saved as Reg_model3_parameters.npz in the current directory!!!")
